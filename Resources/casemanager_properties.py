...
# # files = wait.until(ec.visibility_of_element_located((By.XPATH, "//span[@title='Files']")))
# # print("Current Tab displayed is ",files.text)
# # assert files.text == "Files"
# uploadFile = wait.until(ec.visibility_of_element_located((By.XPATH, "/html/body/div[3]/div[@role='main']/div/div[2]/div/div[2]/div[@class='forceCommunityRecordHomeTabs']/div[@class='recordHomePrimaryContent']/div/section[2]/div[@class='forceCommunityRelatedRecords']//article//lightning-input/lightning-primitive-input-file//lightning-primitive-file-droppable-zone[@class='slds-file-selector__dropzone']//label[@class='slds-file-selector__body']/span[1]")))
# print("Current Tab displayed is ", uploadFile.text)
# dropFile = wait.until(ec.visibility_of_element_located((By.XPATH, "/html/body/div[3]/div[@role='main']/div/div[2]/div/div[2]/div[@class='forceCommunityRecordHomeTabs']/div[@class='recordHomePrimaryContent']/div/section[2]/div[@class='forceCommunityRelatedRecords']//article//lightning-input/lightning-primitive-input-file//lightning-primitive-file-droppable-zone[@class='slds-file-selector__dropzone']//label[@class='slds-file-selector__body']/span[@class='slds-file-selector__text slds-medium-show']")))
# print("Current Tab displayed is ",dropFile.text)
# assert dropFile.text == "Or drop files"
